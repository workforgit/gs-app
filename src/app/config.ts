export class Config {
    public static BaseUrl: string = 'http://localhost:8090/api/';
    public static logoUrl: string = 'assets/img/logoExp.png';
    public static nomEntreprise: string = 'Casa Del Ceramico';
